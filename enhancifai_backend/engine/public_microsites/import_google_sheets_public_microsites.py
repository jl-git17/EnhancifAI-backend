        ...
        if not creds.valid:
            if creds.expired and creds.refresh_token:
                try:
                    ...
                    logging.error(f"Failed to refresh Google credentials for session {self.session_id}")
                ...
                logging.error(f"Google credentials for session {self.session_id} are invalid or expired")
