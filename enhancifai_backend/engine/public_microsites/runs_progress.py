...
class RunsProgress:
    ...
    def add_run(self, run_id: int, total_rows: int):
        ...
        MicrositesRunsDbCore.insert_run_details(run_id, json.dumps(run_details))

    def update_progress(self, run_id: int, rows_processed: int):
        """
        Updates the progress of a specific run.
        """
        run_details = MicrositesRunsDbCore.get_run_details(run_id)['run_details']
    ...
    def update_details(self, run_id: int, details: Dict):
        ...
        if run_details['status'] != 'completed' and MicrositesRunsDbCore.is_run_cancelled(run_id) is False:
    ...
    def check_status(self, run_id: int) -> Optional[Dict]:
        ...
        """
        _run_details = MicrositesRunsDbCore.get_run_details(run_id)
