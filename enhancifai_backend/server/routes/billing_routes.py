...
async def get_usage_history(
    ...
    """
    Retrieve the history of Enhancifai executions and token consumption for the current user.
    """
    try:
...
async def get_rate_card(
    ...
    """
    Retrieve the cost per 1000 tokens for each AI model, supporting filtering by month and year.
    """
    try:
